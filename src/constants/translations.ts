...
export const translations = {
  uz: {
    ...
    contact: {
      ...
      emailErrors: {
        ...
        pattern: "Iltimos haqiqiy pochta manzilini kiriting",
      },
      msgLabel: "Xat matni",
      msgErrors: {
    ...
    dictionary: {
      ...
      searchPlaceholder: "Terminlarni qidirish...",
      ...
      retry: "Qayta urinish",
      relatedTerms: "Aloqador terminlar",
  ...
  ru: {
    ...
    // Home Page
    home: {
      heroTitle: "Дипломатический толковый словарь",
      heroPara1:
    ...
    // About Page
    about: {
      title: "О дипломатическом толковом словаре",
      para1:
        "Словарь включает около 1000 терминов, словосочетаний и названий, используемых в сфере международных отношений в современном узбекском языке — политике и дипломатии. Пособие предназначено для исследователей и студентов университетов и институтов, где преподаются международные отношения и политология, молодых дипломатов, переводчиков, а также для читателей, интересующихся этой областью.",
      para2:
        "Предисловие В соответствии с Указом Президента Республики Узбекистан Ш. М. Мирзиёева от 21 октября 2019 года «О мерах по кардинальному повышению роли и авторитета узбекского языка как государственного» в Кабинете Министров был создан Департамент развития государственного языка для обеспечения соблюдения законодательства о государственном языке, анализа проблем в этой сфере и реализации единой государственной политики, а также Комиссия по терминам, регулирующая работу по официальному введению в использование новых слов и терминов.",
      para3:
        "«Толковый словарь дипломатических терминов», который вы держите в руках, также был создан с целью удовлетворить потребности в этой области в ответ на данные меры. Мы надеемся, что книга станет посильным вкладом в развитие сознания и политической культуры узбекской нации на международной арене, а также в создание литературы, включая словари, служащие для выражения политических вопросов и дипломатических процессов на узбекском языке. Ещё одной целью этого издания было предоставление специалистам в области политики, дипломатии и международных отношений в целом, студентам УМЭД и всем заинтересованным лицам возможности изучать термины, фразы и названия из данной сферы и применять их в своей деятельности.",
      para4:
        "Здесь следует отметить, что, как и во всех сферах, язык дипломатии имеет собственную систему терминов, а её словарный запас состоит из дипломатических, исторических, культурных, лингвистических, юридических и других выражений.",
      para5:
        "Для языка дипломатии характерно большое количество длинных предложений, выражений, вводных слов и союзов. Дипломатический язык значительно отличается от официального языка, в особенности от языка международной политики, языка журналистики и, в какой-то мере, от литературно-художественного языка.",
      para6:
        "Стоит отметить, что дипломатические термины в основном созданы на латинском, английском, французском языках или пришли через них как через языки-посредники. В любом современном языке термины, относящиеся к дипломатии и политике, активно развиваются, поэтому логично предположить, что результаты интеллектуальной деятельности человека, связанной с дипломатией и внешними связями, находят своё отражение в терминах.",
      para7:
        "При отборе терминов в словаре соблюдались критерии и нормы узбекского языка. При составлении словаря как первого исследования в этой области предпринимались попытки соблюсти все традиции и правила лексикографии, а также по мере возможности собрать дипломатические термины, используемые в международной жизни и политике.",
    },
    // Contact Page
    contact: {
      ...
      emailErrors: {
        ...
        pattern: "Пожалуйста, введите действительный адрес электронной почты",
      },
    ...
    // Dictionary Page
    dictionary: {
      title: "Дипломатический Толковый Словарь",
