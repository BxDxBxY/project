...
export const TermCard: React.FC<TermCardProps> = ({
  ...
  return (
    <Link
      ...
      className={`block p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 hover:bg-blue-50 border border-gray-200 hover:border-blue-300 ${className}`}
    >
